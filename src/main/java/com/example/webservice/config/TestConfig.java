...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, "O homem de giz", "Lorem ipsum dolor sit amet, consectetur.", 90.5, "");
		Product p2 = new Product(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas ante.", 2190.0, "");
		Product p3 = new Product(null, "Macbook Pro", "Nam eleifend maximus tortor, at mollis.", 1250.0, "");
		Product p4 = new Product(null, "PC Gamer", "Donec aliquet odio ac rhoncus cursus.", 1200.0, "");
		Product p5 = new Product(null, "Assassinato no expresso oriente", "Cras fringilla convallis sem vel faucibus.", 100.99, "");
		...
		User u1 = new User(null, "Victoria", "victoriaC@gmail.com","999887766","1230203");
		User u2 = new User(null, "Warley","warleycm7@gmail.com","999112233","123.321");
